...
CLERK_API_KEY = os.getenv("sk_test_d3gw1yxNqRlNkqLJSa75xPHdEPYFB5Pf79eoOMe5mH")
CLERK_ISSUER = "https://prime-sculpin-94.clerk.accounts.dev"  # Replace with your Clerk issuer URL
