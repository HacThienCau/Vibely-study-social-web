        ...
        <table className="w-full border border-gray-400 border-collapse mt-4 bg-white">
            <thead>
                <tr className="border border-gray-400 text-left">
                    ...
                    <th className="px-2 py-3 w-1/12 text-center">Số trang</th>
                    <th className="px-2 py-3 w-1/9 text-center">Ngày đăng tải</th>
                    <th className="px-2 py-3 w-1/9 text-center">Ngày cập nhật</th>
            ...
            <tbody>
                {documents.map((doc) => (
                    <tr key={doc._id} className="border-t border-gray-300 text-left">
                        ...
                        <td className="px-2 py-3 w-3/20 whitespace-nowrap">{doc.level.name}</td>
                        <td className="px-2 py-3 w-1/10 whitespace-nowrap">{doc.subject.name}</td>
                        <td className="px-2 py-3 w-1/12 text-center">{doc.pages}</td>
                        <td className="px-2 py-3 w-1/9 text-center">{formatDate(doc.uploadDate)}</td>
                        <td className="px-2 py-3 w-1/9 text-center">{formatDate(doc.updatedAt)}</td>
