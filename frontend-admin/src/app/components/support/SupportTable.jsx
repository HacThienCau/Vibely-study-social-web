        ...
        <table className="w-full border border-gray-400 border-collapse mt-4 bg-white">
            <thead>
                <tr className="border border-gray-400 text-left">
                    ...
                    <th className="px-2 py-3 w-7/20">Nội dung thắc mắc</th>
                    <th className="px-2 py-3 w-1/12 text-center">Ngày gửi</th>
            ...
            <tbody>
                {inquiries.map((inq) => (
                    <tr key={inq._id} className="border-t border-gray-300 text-left">
                        ...
                        <td className="px-2 py-3 w-7/20 break-words">{inq.message}</td>
                        <td className="px-2 py-3 w-1/12 text-center">{formatDate(inq.createdAt)}</td>
