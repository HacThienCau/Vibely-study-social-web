...
//     // Gọi API để lọc tài liệu theo cấp học và môn học
//     useEffect(() => {
//         const fetchFilteredDocs = async () => {
//             if (!token) return;
...
//         fetchFilteredDocs();
//     }, [selectedLevelId, selectedSubjectId, token]);
...
//         try {
//             const res = await axios.get(`http://localhost:8080/documents/search?query=${query}`, {
//                 headers: { Authorization: `Bearer ${token}` },
//             });
//             setDocuments(res.data.data);
//         } catch (err) {
...
//                 {/* Thanh tìm kiếm */}
//                 <SearchDocument onSearch={handleSearch} />
